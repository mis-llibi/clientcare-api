...
<body>
    ...
    <p style="font-weight: normal;">
        Hi <b>{{ $provider_name }}</b>
        <br><br>

        {{ $patient_name }} have successfully submitted his/her request for LOA.<br><br>

        Our Client Care will respond to the request within {{ $within }} minutes.<br><br>

        His/Her reference number is <b>{{ $ref }}</b><br><br>
