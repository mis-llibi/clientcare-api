...
<body>
    ...
    <div class="container-p-body">
    	...
    	<span>2. Patient must be present validated laboratory form to the laboratory section of the accredited hospital for prescribed procedures to be done.</span><br />
    	<span>3. Credit and Collection should forward all billings with copy of this laboratory form within 30 days to Lacson & Lacson for collection of payment.</span><br />
    </div>
    ...
    <table style="margin-top: 5px; width: 100%; ">
    	<tr>
     	...
     	<tr>
        	<td></td>
            <td style="font-size:8px;">HALCYON HEALTH NETWORK, INC.</td>
        </tr>
     	<tr>
        	<td></td>
