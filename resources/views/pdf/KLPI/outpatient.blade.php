...
<body>
    ...
    <div class="container-p-body">
    	...
    	<span>2. If laboratory / diagnostic tests are required, doctor should return a copy to patient.</span><br />
    </div>
    ...
    <table style="margin-top: 5px; width: 100%; ">
    	<tr>
            ...
            <td class="td-value">{{ $document_datetime }} / (valid for 5 days from date of issuance)</td>
        </tr>
     	<tr>
    ...
    <table style="margin-top: 5px; width: 100%; ">
    	<tr>
     	...
     	<tr>
        	<td></td>
            <td style="font-size:8px;">KLN FREIGHT (PHILS.), INC.</td>
        </tr>
     	<tr>
        	<td></td>
