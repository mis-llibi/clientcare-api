    ...
    <table style="width:100%; border-collapse:collapse;">
        <tr>
            <td style="width:48%; vertical-align:top; padding-right:5px;">
                ...
                <table style="margin-top: 5px; width: 100%; ">
                    <tr>
                        ...
                        <td class="td-value">{{ $document_datetime }} / 04:22:50 pm (valid for 7 days from date of issuance)</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="td-value underline">September 03, 2025</td>
                    </tr>
                </table>
                <table style="margin-top: 5px; width: 100%; ">
                    <tr>
                        <td class="td-title">To :</td>
                        <td class="td-value" style="width:40%;">Dr. Juan Dela Cruz </td>
                        <td><img src="{{ $confidential }}" style="width:15%; position:absolute;"> </td>
                    </tr>
                    <tr>
                        <td class="td-title"></td>
                        <td class="" style="font-size:8px;">University of Cebu Medical Center, Inc. </td>
                    </tr>
                </table>
                <table style="margin-top: 5px; width: 100%; ">
                    <tr>
                        <td class="td-title">Re :</td>
                        <td class="td-value">QUINTANO, JEREMIAH M</td>
                    </tr>
                    <tr>
                        <td></td>
                    ...
                    <tr>
                        <td></td>
                        <td style="color:#b61a02; font-weight:bold;" >(PATIENT) QUINTANO, JEREMIAH M</td>
                    </tr>
                </table>
                ...
                <table style="margin-top: 5px; width: 100%;">
                    <tr>
                        ...
                        <td class="td-value underline">DASADSA</td>
                    </tr>
                    <tr>
                        <td style="text-align: right; width: 15%;">Diagnosis :</td>
                        <td class="td-value underline">ewqee</td>
                    </tr>
                </table>
                <p style="margin-left: 20px;">Prescribed laboratory & Diagnostics test(s)</p>
                <table style=" width: 100%; ">
                    <tr>
                        <td class="td-value underline" style="width: 100%;">ewqeqwewq</td>
                    </tr>
                </table>
                    ...
                    <tr>
                        ...
                        <table style="width:100%; border-collapse:collapse;">
                            ...
                            <td style="white-space:nowrap;">
                                ...
                                <td style="border-bottom:1px solid #000; width:100%;">&nbsp; dsadsads</td>
                            </tr>
                            <tr>
                        ...
                        <table style="width:100%; border-collapse:collapse;">
                            <tr>
                                <td style="border-bottom:1px solid #000; width:70%; text-align:center;">
                                    <span style="display:inline-block; width:100%; text-align:center;">ewqewqewq</span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="text-align:center; padding-top:30px;">
                                    TIN: <span style="display:inline-block; border-bottom:1px solid #000; width:150px;">ewqeqweqweqweqw</span>
                                </td>
                            </tr>
                        </table>
                        </td>
            ...
            <td style="width:48%; vertical-align:top; padding-right:5px;">
                ...
                <div style="margin-top: 5px; background-color: #e6e6e6; text-align: center; padding: 0.5px 0px; ">
                    <h2 style="font-weight: bold;" >OUTPATIENT LETTER OF AUTHORITY</h2>
                    <h2 style="color: #b61a02;" >OUTPATIENT PROCEDURE</h2>
                </div>
                <div class="container-p-body">
                ...
                <table style="margin-top: 5px; width: 100%; ">
                    <tr>
                        <td class="td-title">Date and Time :</td>
                        <td class="td-value">September 3, 2025 / 04:22:50 pm (valid for 7 days from date of issuance)</td>
                    </tr>
                    <tr>
                        <td class="td-title">Doc No :</td>
                        <td class="td-value">dsadas</td>
                    </tr>
                    <tr>
                        <td class="td-title">Consultation Date :</td>
                        <td class="td-value underline">September 03, 2025</td>
                ...
                <table style="margin-top: 5px; width: 100%; ">
                    <tr>
                        <td class="td-title">To :</td>
                        <td class="td-value">Dr. Juan Dela Cruz </td>
                    </tr>
                    <tr>
                        <td class="td-title"></td>
                        <td class="" style="font-size:8px;">University of Cebu Medical Center, Inc. </td>
